    ...
    <div class="h-[87vh]">
        ...
        <form action="#" method="POST">
            <div class="bg-gray-200">
                ...
                <div class="container mx-auto flex justify-around">
                    <div class="w-1/3 pt-9">
                        ...
                        <h6 class="font-light pt-2">ข้อมูลสำหรับให้ทางทีมงาน at Finder ติดต่อกับทางมูลนิธิ</h6>
                    </div>
                    <div class="w-3/5 my-8 bg-white shadow rounded-t-md">
                        <div class="p-7 max-w-lg">
                            <div class="grid grid-cols-1 gap-6 pb-5">
            ...
            <div class="container mx-auto flex justify-end">
                <button class="rounded-[4px] bg-iris text-[18px] text-white font-normal text-center py-2.5 px-5 mt-8 mr-7">ยืนยัน</button>
            </div>
        </form>
    </div>
  )
