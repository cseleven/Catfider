...
export default async function handler(req, res) {
    ...
    let query = supabase
        ...
        .select('cat_id, cat_name, detail, age, sex, breed, color, sterile, vaccine, status, cat_picture, shelter_id, shelter_profile!inner(shelter_name, donate_name1, donate_number1, donate_name2, donate_number2), queue!inner(queue_date, user_id, queue_status)')
